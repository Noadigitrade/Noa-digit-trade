    ...
    walletHelp.textContent =
      onChain
        ...
        : currentNetwork === 'uid'
          ...
          : "⚠️ Indiquez votre UID : vos USDT seront envoyés par transfert interne, sans frais réseau.";
  }
}
